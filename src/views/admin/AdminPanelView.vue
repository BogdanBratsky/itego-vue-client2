    ...
    <header class="header">
        ...
        <div class="admin-nav">
            <router-link to="/admin/articles">
                <div class="admin-nav__item">Статьи</div>
            </router-link>
            <router-link to="/admin/categories">
                <div class="admin-nav__item">Категории</div>
            </router-link>
            <router-link v-if="superuser" to="/admin/users">
                <div class="admin-nav__item">Пользователи</div>
            </router-link>
        </div>
        <nav class="header__nav">
            <router-link to="/blog">
                <div class="header__mainpage-btn">В блог</div>
            </router-link>
